...
The algorithm's main idea is illustrated in Equation \ref{aoeq:3}: Given the movie to match and a candidate, the score is determined as the fraction of the movie's actors, which can also be found in the candidate movie's actors.
