...
\begin{itemize}
  \item
    In 82\% of the wrong matches the actual movie was not in the database, but the system returned a match
	\item
    In the remaining cases, the algorithm used an inprecise cut of the threshold
\end{itemize}
