...
Section, Chapter usw. groß oder klein schreiben wenn man darauf referenziert? \\
Kursivschreibung kontrollieren! Nur das erste Vorkommen kursiv \\
Platzierung der Bilder immer erst nach der ersten Referenz! \\
Wir Formen vermeiden! \\
Passendere Übreschriften finden, nicht die Standard Überschriften verwenden (fanden die beim letzten Mal nicht so gut)
\\ \\
