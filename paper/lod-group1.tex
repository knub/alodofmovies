...
Entities have different representations in different data sources, which is why a matching algorithm has to be developed.
In this paper, a matching algorithm is explained and evaluated.
The evaluation shows, that ... %TODO Stefan Dominik
