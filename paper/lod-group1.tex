...
This paper describes the system \emph{Match Forrest, Match!}, which aggregates and links movie data from different online movie data sources to a unified, linked open data set.
